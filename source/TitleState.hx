	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['BEST MOD'], 15);
					#else
					createCoolText(['VS MIGHTY']);
					#end
				// credTextShit.visible = true;
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('Mighty', 15);
					addMoreText('B0YFR1END', 15);
					addMoreText('and murilo', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Crystal Engine', 'By'], -40);
				case 7:
					addMoreText('THE BEST CODERS');
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				...
				// credTextShit.screenCenter();
				case 13:
					createCoolText(['COOLER THAN'], -40);
					case 14:
						addMoreText('MOB MOD');
						case 15:
							addMoreText('NOT INSPIRED');
							case 16:
								deleteCoolText();
				case 17:
				...
				// credTextShit.visible = true;
				case 18:
					addMoreText('VS MIGHTY');
				// credTextShit.text += '\nNight';
				case 19:
					addMoreText('LETS'); // credTextShit.text += '\nFunkin';
