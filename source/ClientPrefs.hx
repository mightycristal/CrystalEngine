...
class ClientPrefs {
	...
	public static var healthGain:Int = 1;
	public static var healthLoss:Int = 1;
	...
	public static var visuals:String = 'menu';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.practice = practiceMode;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.practice != null) {
			practiceMode = FlxG.save.data.practice;
		}
